"""Plot GSM8K population scaling for N=1, 8, 16 only (seeds 42/43/44).

Usage:
  uv run python -m src.scripts.plot_pop_scaling_n1_8_16
  uv run python -m src.scripts.plot_pop_scaling_n1_8_16 --out results/pop_scaling_n1_8_16.png
"""
...
COLORS = {1: "#e41a1c", 8: "#377eb8", 16: "#984ea3"}
...
def main() -> None:
    ...
    p.add_argument("--out", default="results/pop_scaling_n1_8_16.png")
    args = p.parse_args()
